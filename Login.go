...
func LoginRequest(w http.ResponseWriter, r *http.Request) {
	...
	if ok {
		...
		a := NewCookie(GenerateToken(Jheader{Alg: "HS256", Typ: "JWT"}, JPayload{Userid: loguser.Userid, LoggedinAs: permission, Exp: time.Now().Add(15 * time.Minute), SessionID: r.UserAgent() + forwarded}))
		http.SetCookie(w, a)
